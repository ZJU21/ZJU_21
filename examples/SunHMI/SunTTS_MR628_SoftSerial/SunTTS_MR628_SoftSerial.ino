...
SoftwareSerial mySerial(13, 10); // (RX, TX)(A8, A9)
...
void loop() {
  //<I>18  提示音 1
  //<I>19  提示音 2
mySerial.print("<I>18");//播放提示音1
  delay(2000);
  //<M>1  背景音乐 1
  //<M>2  背景音乐 2
  //<M>0  关闭音乐
mySerial.print("<M>0");//背景音乐 1
  delay(50);
mySerial.print(sound0);//发送语音合成指令
  delay(6000);
mySerial.print(sound1);//发送语音合成指令  
  delay(6000);
mySerial.print(sound2);//发送语音合成指令  
  delay(6000);
